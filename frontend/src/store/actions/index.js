    ...
    try {
      ...
      const resolvedIsAdmin =
        typeof isAdmin === "boolean"
          ? isAdmin
          : hasRole(getState().auth.user, "ROLE_ADMIN");
      const endpoint = resolvedIsAdmin ? "/admin/orders" : "/seller/orders";
...
export const updateProductFromDashboard =
  (sendData, toast, reset, setLoader, setOpen, isAdmin, refreshProducts) =>
  async () => {
    try {
      setLoader(true);
      const endpoint = isAdmin ? "/admin/products/" : "/seller/products/";
...
export const deleteProduct =
  (setLoader, productId, toast, setOpenDeleteModal, isAdmin, refreshProducts) =>
  async () => {
    try {
      setLoader(true);
      const endpoint = isAdmin ? "/admin/products/" : "/seller/products/";
...
export const updateProductImageFromDashboard =
  (formData, productId, toast, setLoader, setOpen, isAdmin, refreshProducts) =>
  async () => {
    try {
      setLoader(true);
      const endpoint = isAdmin ? "/admin/products/" : "/seller/products/";
